...
<script>
import { listRecord, getRecord, delRecord, addRecord, updateRecord } from "@/api/video/userCollectRecord";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户收藏记录编号为"' + ids + '"的数据项？').then(function() {
