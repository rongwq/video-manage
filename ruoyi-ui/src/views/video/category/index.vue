...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory } from "@/api/video/category";
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('是否确认删除视频分类编号为"' + row.id + '"的数据项？').then(function() {
