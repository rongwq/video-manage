...
public class VideoCategoryController extends BaseController
{
    ...
    @GetMapping("/list")
    public AjaxResult list(VideoCategory videoCategory)
    {
    ...
    public AjaxResult treeselect(VideoCategory videoCategory)
    {
        List<VideoCategory> treeList = videoCategoryService.selectVideoCategoryList(videoCategory);
        return success(videoCategoryService.buildTreeSelect(treeList));
    }
