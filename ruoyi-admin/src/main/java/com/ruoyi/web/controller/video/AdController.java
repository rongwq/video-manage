...
public class AdController extends BaseController
{
     ...
     * 导出广告列表
     */
    @PreAuthorize("@ss.hasPermi('system:ad:export')")
     ...
     * 获取广告详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:ad:query')")
    @GetMapping(value = "/{id}")
     ...
     * 修改广告
     */
    @PreAuthorize("@ss.hasPermi('system:ad:edit')")
     ...
     * 删除广告
     */
    @PreAuthorize("@ss.hasPermi('system:ad:remove')")
